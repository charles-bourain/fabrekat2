...
from project.forms import ProjectImageForm, ProjectImageFormSet, ProjectStepForm
...
class ProjectCreateView(LoginRequiredMixin, CreateView):
	...
	def form_valid(self, form):
		...
		# print 'ProjectSTepINstance = ' +str(ProjectStep.objects.get(step_for_project = self.object))

		# purchasedcomponent_formset.instance = ProjectStep.objects.get(step_for_project = self.object)
		# purchasedcomponent_formset.save()

		# fabricatedcomponent_formset.instance = self.object
		# fabricatedcomponent_formset.instance.fabricated_component_for_step = projectstep_formset.instance
		...
		# projectfile_formset.instance.project_file_for_step = projectstep_formset.instance
...
def edit_project(request, project_id):
	...
	if user_id != creator_id:
		...
		projectstep  = list(ProjectStep.objects.filter(
			step_for_project = project_index,
			),
		)
